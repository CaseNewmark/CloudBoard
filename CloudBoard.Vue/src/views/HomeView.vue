  ...
  <div class="min-h-full bg-gray-50">
    <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      <div class="text-center">
        <div class="mb-8">
          <i class="pi pi-clipboard text-purple-800" style="font-size: 4rem"></i>
        </div>
        ...
        <div class="mt-10 flex items-center justify-center gap-x-6">
          <template v-if="!authStore.isLoggedIn">
            ...
            <RouterLink to="/login" class="text-sm font-semibold leading-6 text-gray-900 hover:text-purple-600">
      ...
      <div class="mt-16">
        <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
          <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            <div class="mb-4">
              <i class="pi pi-sitemap text-purple-600" style="font-size: 2rem"></i>
            </div>
            <h3 class="text-lg font-semibold text-gray-900 mb-2">Cloudboard</h3>
            <p class="text-gray-600">
              Visualize your workflows and processes with interactive flowcharts and diagrams.
            </p>
          </div>
